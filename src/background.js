...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
  ...
  if (request.action === "openPopupWithSymbol") {
    console.log(`Action "openPopupWithSymbol" received. Symbol: ${request.symbolName}`);

    // This is an asynchronous operation.
    chrome.storage.local.set({ currentSymbolName: request.symbolName, currentSymbolId: request.symbolId }, () => {
